...
void D3D::Initialise( IDirect3DDevice9 *device ) {
	...
	D3D9Fonts[ TAB_FONT ] = D3D9DrawManager->add_font(XOR( "C:\\Windows\\Fonts\\segoeuib.ttf" ), 32.f,
		false, false, util::draw::GLYPH_RANGE_LATIN, util::draw::NO_ANTIALIASING | util::draw::MONO_HINTING );	

	D3D9Fonts[ MeinerWare_FONT ] = D3D9DrawManager->add_font(XOR( "C:\\Windows\\Fonts\\segoeuib.ttf" ), 42.f,
		false, false, util::draw::GLYPH_RANGE_LATIN, util::draw::NO_ANTIALIASING | util::draw::MONO_HINTING );	
	
	D3D9Fonts[ PIXEL_FONT ] = D3D9DrawManager->add_font(XOR( "C:\\Windows\\Fonts\\segoeuib.ttf" ), 8.f,
		false, false, util::draw::GLYPH_RANGE_LATIN, util::draw::NO_ANTIALIASING | util::draw::MONO_HINTING );

	D3D9Textures[ TITLEBAR_TEXTURE ] = std::make_unique<SimpleSprite>( D3D9DrawManager, util::draw::position( 646, 30 ), title_bar_data );
}
