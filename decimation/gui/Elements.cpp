		...
		if( GUI::Form::BeginWindow( XOR( "Pandora" ) ) ) {
			...
			if( GUI::Form::BeginTab( XOR( "A" ), XOR( "Aimbot" ) ) ) {
				if( GUI::Form::BeginSubTab( XOR( "X" ), XOR( "Aimbot" ) ) ) {
					GUI::Group::BeginGroup( XOR( "General" ), vec2_t( 77, 95 ) ); {
					...
					GUI::Group::BeginGroup( XOR( "Accuracy" ), vec2_t( 77, 95) ); {
				...
				if( GUI::Form::BeginSubTab( XOR( "X" ), XOR( "Anti-aim" ) ) ) {
					GUI::Group::BeginGroup( XOR( "Real anti-aim" ), vec2_t( 50, 95) ); {
					...
					GUI::Group::BeginGroup( XOR( "Fake anti-aim" ), vec2_t( 50, 95) ); {
					...
					GUI::Group::BeginGroup( XOR( "Fake-lag" ), vec2_t( 50, 95) ); {
			...
			if (GUI::Form::BeginTab(XOR("D"), XOR("Legit"))) {
			}

			if (GUI::Form::BeginTab(XOR("E"), XOR("LUA"))) {
			}
